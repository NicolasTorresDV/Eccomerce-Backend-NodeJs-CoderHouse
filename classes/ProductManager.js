...
class ProductManager{
    ...
    addProduct(product){
        ...
        let newProduct = new Product(newID, product.title, product.description, product.price, product.status, product.thumbnail, product.code, product.stock)
    ...
    updateProduct(id,product){
        console.log(product);
        this.products = JSON.parse(fs.readFileSync(this.path.toString(),'utf-8'));
        let updatedProducts = this.getProductById(id)
